"""Test script for formatting functionality."""
...
from gitingest.schemas.filesystem import FileSystemFile, GitRepository
...
# Results can be inspected with debugger or logging if needed
