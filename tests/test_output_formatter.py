...
"""
# pylint: disable=redefined-outer-name  # pytest fixtures are expected to redefine names
...
from gitingest.schemas import FileSystemDirectory, FileSystemFile, FileSystemSymlink, IngestionQuery
...
class TestDefaultFormatter:
    ...
    def test_format_file_node(self, mock_file_node: FileSystemFile, mock_query: IngestionQuery) -> None:
    ...
    def test_format_directory_node(self, mock_directory_node: FileSystemDirectory, mock_query: IngestionQuery) -> None:
        ...
        with patch.object(
            formatter,
            "format",
            side_effect=lambda node, _: f"formatted_{node.name}" if hasattr(node, "name") else "formatted_child",
        ) as mock_format:
            ...
            mock_format.side_effect = lambda node, _: f"formatted_{getattr(node, 'name', 'child')}"
            formatter.format(mock_directory_node, mock_query)

    def test_format_symlink_node(
        self,
        mock_symlink_node: FileSystemSymlink,
        mock_query: IngestionQuery,
    ) -> None:
    ...
    def test_format_symlink_node_no_target(
        self,
        mock_symlink_node: FileSystemSymlink,
        mock_query: IngestionQuery,
    ) -> None:
...
class TestSummaryFormatter:
    ...
    def test_summary_directory_node(
        self,
        mock_directory_node: FileSystemDirectory,
        mock_query: IngestionQuery,
    ) -> None:
    ...
    def test_summary_file_node_default(
        self,
...
class TestDebugFormatter:
    ...
    def test_format_file_node_debug_info(
        self,
        mock_file_node: FileSystemFile,
        mock_query: IngestionQuery,
    ) -> None:
    ...
    def test_format_directory_node_debug_info(
        self,
        mock_directory_node: FileSystemDirectory,
        mock_query: IngestionQuery,
    ) -> None:
    ...
    def test_format_symlink_node_debug_info(
        self,
        mock_symlink_node: FileSystemSymlink,
        mock_query: IngestionQuery,
    ) -> None:
    ...
    def test_format_all_node_types_show_debug(
        self,
        mock_file_node: FileSystemFile,
        mock_directory_node: FileSystemDirectory,
        mock_symlink_node: FileSystemSymlink,
    ...
    def test_debug_formatter_vs_default_formatter(
        self,
        mock_file_node: FileSystemFile,
        mock_query: IngestionQuery,
    ) -> None:
...
class TestFormatterEdgeCases:
    ...
    def test_format_unknown_node_type(self, mock_query: IngestionQuery) -> None:
    ...
    def test_format_node_without_name(self, mock_query: IngestionQuery) -> None:
    ...
    def test_format_with_none_query(self, mock_file_node: FileSystemFile) -> None:
