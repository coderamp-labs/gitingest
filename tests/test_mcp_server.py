...
class TestMCPListTools:
    ...
    @pytest.mark.asyncio
    async def test_list_tools_returns_correct_tools(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_tools_schema_validation(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_tools_source_examples(self) -> None:
...
class TestMCPCallTool:
    ...
    @pytest.mark.asyncio
    async def test_call_tool_ingest_repository_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_call_tool_logs_errors(self) -> None:
        ...
        with (
            ...
            args, _kwargs = mock_logger.exception.call_args
            assert args == ("Error in tool call %s", "ingest_repository")
...
class TestHandleIngestRepository:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_minimal_args(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_all_args(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_pattern_conversion(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_none_patterns(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_exception(self) -> None:
        ...
        with (
            ...
            mock_logger.exception.assert_called_once()
            args, _kwargs = mock_logger.exception.call_args
            assert args == ("Error during ingestion",)

    @pytest.mark.asyncio
    async def test_handle_ingest_repository_logs_info(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_response_format(self) -> None:
...
class TestMCPServerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_server_instance_created(self) -> None:
        """Test that the MCP server instance is properly created."""
        assert app is not None
        assert app.name == "gitingest"

    @pytest.mark.asyncio
    async def test_start_mcp_server_calls_stdio(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_mcp_server_logs_startup(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_run_stdio_integration(self) -> None:
        ...
        with patch("gitingest.mcp_server.stdio_server") as mock_stdio_server:
            ...
            with (
                ...
                expected_args = 3  # read_stream, write_stream, init_options
                assert len(call_args) == expected_args
...
class TestMCPServerParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_ingest_repository_missing_source(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ingest_repository_invalid_parameters(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ingest_repository_empty_patterns(self) -> None:
...
class TestMCPServerEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_call_tool_empty_arguments(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_ingest_repository_partial_results(self) -> None:
    ...
    async def test_concurrent_tool_calls(self) -> None:
        ...
        with patch("gitingest.mcp_server.ingest_async") as mock_ingest:
            ...
            num_tasks = 3
            tasks = [call_tool("ingest_repository", {"source": f"test-{i}"}) for i in range(num_tasks)]
